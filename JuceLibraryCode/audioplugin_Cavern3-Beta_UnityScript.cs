...
public class audioplugin_Cavern3-BetaGUI : IAudioEffectPluginGUI
{
    public override string Name           { get { return "audioplugin_Cavern3-Beta"; } }
    public override string Description    { get { return "Cavern3-Beta"; } }
    public override string Vendor         { get { return "TekRecords"; } }

    //==============================================================================
	[DllImport("audioplugin_Cavern3-Beta")] static extern System.IntPtr getRenderCallback();

    [DllImport("audioplugin_Cavern3-Beta")] static extern void unityInitialiseTexture (int id, System.IntPtr texture, int width, int height);

    [DllImport("audioplugin_Cavern3-Beta")] static extern void unityMouseDown (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_Cavern3-Beta")] static extern void unityMouseDrag (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_Cavern3-Beta")] static extern void unityMouseUp   (int id, float x, float y, EventModifiers mods);

    [DllImport("audioplugin_Cavern3-Beta")] static extern void unityKeyEvent (int id, KeyCode code, EventModifiers mods, string name);

    [DllImport("audioplugin_Cavern3-Beta")] static extern void unitySetScreenBounds (int id, float x, float y, float w, float h);
